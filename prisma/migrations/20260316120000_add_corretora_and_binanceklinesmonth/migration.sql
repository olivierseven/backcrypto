-- Add corretora to BinanceKlineFast and BinanceKline; create BinanceKlineMonth.
-- Safe for production: ADD COLUMN with DEFAULT, then PK/index changes.
...
-- ---------- BinanceKlineMonth (same structure as BinanceKline) ----------
