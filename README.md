...
- STRIPE_SECRET_KEY, PRICE_COINS_7, PRICE_COINS_49, STRIPE_WEBHOOK_SECRET
- PAGARME_SECRET_KEY, PAGARME_WEBHOOK_USER, PAGARME_WEBHOOK_PASSWORD, PAGARME_ACCOUNT_ID
- PIX_TEST_AMOUNT_BRL_CENTS (opcional; override em centavos BRL para teste do plano $7)
